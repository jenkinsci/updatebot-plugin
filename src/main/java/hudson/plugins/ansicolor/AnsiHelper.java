...
public class AnsiHelper {
    ...
    public static final AnsiHtmlOutputStream createAnsiStream(final OutputStream logger) {
        return createAnsiStream(logger, AnsiColorMap.XTerm);
    }

    public static AnsiHtmlOutputStream createAnsiStream(OutputStream logger, AnsiColorMap colorMap) {
